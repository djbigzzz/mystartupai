...
import { Sparkles, TrendingUp, Users, Target, AlertCircle, Lightbulb, ArrowRight, RotateCcw } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-bold">The Validator</h1>
          </div>
          ...
          <div>
            ...
            {validateMutation.isPending && (
              <Card className="h-full flex items-center justify-center p-12">
                <div className="text-center">
                  <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-primary mx-auto mb-4"></div>
                  <p className="font-medium mb-2">Validating your idea...</p>
                  <p className="text-sm text-muted-foreground">
                    Running real-time market research and AI analysis
                  </p>
                </div>
              </Card>
            )}
