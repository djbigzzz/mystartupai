                ...
                <CardContent className="text-center py-16">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <Link href="/submit-idea">
                      <Button className="bg-green-600 hover:bg-green-700" data-testid="button-submit-idea">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900 dark:text-white" data-testid="text-page-title">Financial Modeling</h1>
                <p className="text-gray-600 dark:text-gray-300" data-testid="text-current-idea">Creating financial model for: {idea?.ideaTitle}</p>
              </div>
            </div>
