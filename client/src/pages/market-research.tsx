              ...
              <div className="max-w-6xl mx-auto">
                <Card className="border-0 shadow-lg" data-testid="card-no-idea-selected">
                  <CardContent className="text-center py-12 lg:py-16">
                    <Search className="w-12 h-12 lg:w-16 lg:h-16 text-gray-300 mx-auto mb-6" />
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                      <Link href="/submit-idea">
                        <Button className="bg-blue-600 hover:bg-blue-700 w-full sm:w-auto" data-testid="button-submit-idea">
                      ...
                      return (
                        <Card key={index} className="border-0 shadow-sm" data-testid={`card-benefit-${index}`}>
                          <CardContent className="p-4 lg:p-6 text-center">
                            <div className="w-10 h-10 lg:w-12 lg:h-12 bg-blue-100 dark:bg-blue-900 rounded-xl flex items-center justify-center mx-auto mb-4">
                              <IconComponent className="w-5 h-5 lg:w-6 lg:h-6 text-blue-600 dark:text-blue-400" />
                            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 lg:py-6">
              <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center space-x-2 lg:space-x-4">
                  ...
                  <div>
                    <h1 className="text-xl lg:text-2xl font-bold text-gray-900 dark:text-white" data-testid="text-page-title">Market Research</h1>
                    <p className="text-sm lg:text-base text-gray-600 dark:text-gray-300" data-testid="text-current-idea">Analyzing market for: {idea?.ideaTitle}</p>
                  </div>
                </div>
