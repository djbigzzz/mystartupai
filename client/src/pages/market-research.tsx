  ...
  const benefits = [
    {
      ...
      description: "Comprehensive market size, growth, and opportunity assessment"
    },
    {
      icon: Target,
      title: "Competitive Intelligence",
      description: "Detailed competitor analysis with strengths and weaknesses"
    },
    {
      icon: Users,
      title: "Customer Personas",
      description: "Detailed customer profiles with pain points and motivations"
    },
    {
      icon: TrendingUp,
      title: "Market Trends",
      description: "Key industry trends and their impact on your business"
    }
  ];
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            <Search className="w-12 h-12 text-blue-600 animate-pulse mx-auto mb-4" />
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="flex-1 p-6 overflow-auto">
            ...
            <div className="max-w-6xl mx-auto">
              <Card className="border-0 shadow-lg" data-testid="card-no-idea-selected">
                <CardContent className="text-center py-16">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto" data-testid="text-no-idea-description">
                    To conduct market research, you need to submit and validate a startup idea first. 
                    Our AI will analyze your market opportunity and competitive landscape.
                  </p>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <Link href="/business-plan">
                      <Button variant="outline" data-testid="button-business-plan-first">
              ...
              {/* Benefits Section */}
              <div className="mt-12">
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white text-center mb-8" data-testid="text-benefits-title">
                  What You'll Get
                </h2>
                    ...
                    return (
                      <Card key={index} className="border-0 shadow-sm" data-testid={`card-benefit-${index}`}>
                        <CardContent className="p-6 text-center">
                          ...
                          <h3 className="font-semibold text-gray-900 dark:text-white mb-2" data-testid={`text-benefit-title-${index}`}>{benefit.title}</h3>
                          <p className="text-gray-600 dark:text-gray-300 text-sm" data-testid={`text-benefit-description-${index}`}>{benefit.description}</p>
                        </CardContent>
                      </Card>
                    );
                  })}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-gray-900 dark:text-white" data-testid="text-page-title">Market Research</h1>
                  <p className="text-gray-600 dark:text-gray-300" data-testid="text-current-idea">Analyzing market for: {idea?.ideaTitle}</p>
                </div>
              </div>
