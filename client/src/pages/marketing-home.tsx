  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white overflow-x-hidden">
      ...
      <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
        scrollY > 50 ? 'bg-black/40 backdrop-blur-xl border-b border-white/5' : ''
      }`}>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className={`relative z-10 transition-all duration-1000 transform ${
              ...
              <div className="mt-10 space-y-4 max-w-md">
                <Link href="/login">
                  <Button 
                    className="w-full bg-white hover:bg-gray-50 text-black rounded-2xl h-14 text-base font-medium shadow-xl hover:shadow-2xl transition-all duration-300 group"
                ...
                <div className="flex gap-4">
                  <Link href="/login" className="flex-1">
                    <Button 
                      variant="outline"
                      className="w-full h-14 rounded-2xl bg-white/5 border-white/10 hover:bg-white/10 backdrop-blur-sm transition-all duration-300 hover:scale-105"
                  ...
                  <Link href="/login" className="flex-1">
                    ...
                    >
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M17.05 20.28c-.98.95-2.05.88-3.08.35-1.09-.55-2.08-.56-3.29 0-1.54.71-2.34.5-3.27-.37C2.25 15.04 3.01 8.94 8.75 8.67c1.42.06 2.4.74 3.22.76.82.02 2.27-.88 3.82-.79 2.04.14 3.56 1.09 4.35 2.82-3.97 2.38-2.99 7.63.86 8.82zM12.03 8.63c-.14-2.5 1.93-4.58 4.35-4.8.32 2.66-2.46 4.87-4.35 4.8z"/>
                      </svg>
                    </Button>
                  </Link>
                  <Link href="/login" className="flex-1">
                    <Button 
                      variant="outline"
                      className="w-full h-14 rounded-2xl bg-gradient-to-br from-purple-500/10 to-pink-500/10 border-purple-500/20 hover:from-purple-500/20 hover:to-pink-500/20 backdrop-blur-sm transition-all duration-300 hover:scale-105"
                ...
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-xs">
                    <span className="bg-[#0A0A0A] px-4 text-gray-500">Or log in with email</span>
                  </div>
                </div>

                <Link href="/login">
                  <Button 
                    className="w-full bg-gradient-to-r from-emerald-500 to-green-600 hover:from-emerald-600 hover:to-green-700 text-white rounded-2xl h-14 text-base font-medium shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 group"
            ...
            <div className={`relative z-10 hidden lg:block transition-all duration-1000 delay-300 transform ${
                  ...
                  <div className="flex items-center justify-between mb-8">
                    <div className="flex items-center gap-2">
                      <div className="flex -space-x-2">
                        {[...Array(4)].map((_, i) => (
                          <div key={i} className="w-8 h-8 rounded-full bg-gradient-to-br from-blue-400 to-purple-400 border-2 border-[#0A0A0A] flex items-center justify-center">
                            <span className="text-xs font-bold">{i + 1}</span>
                          </div>
                        ))}
                      </div>
                      <span className="text-sm text-gray-400 ml-2">Trusted by 1.5M+ Users</span>
                    </div>
                  </div>
              ...
              <div className="mt-12 grid grid-cols-3 gap-6 text-center">
                {[
                  ...
                  { value: '50M+', label: 'Generated' },
                  { value: '180+', label: 'Countries' }
                ].map((stat, i) => (
                  <div key={i} className="group cursor-pointer">
                    <div className="text-3xl font-bold bg-gradient-to-br from-blue-400 to-purple-400 bg-clip-text text-transparent group-hover:scale-110 transition-transform">
                      {stat.value}
                    </div>
